                ...
                {requests.map((request: Request) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-gray-500">
                        {formatBytes(request.requestSize || 0)}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-gray-500">
                        {formatBytes(request.responseSize || 0)}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-gray-500">
                        {request.error ? (
                          <span className="text-red-600" title={request.error}>
                            {request.error.length > 30
                              ? `${request.error.substring(0, 30)}...`
                              : request.error}
                          </span>
                        ) : (
                          'N/A'
